---
title: South Okanagan Bat Hibernacula Project
...
Work occurred in the South Okanagan in 2024/25 (Skurihina and Kellner 2025 to assess the feasibility of fall/winter bat capture and tracking in south Okanagan parks and protected areas and, if successful, to identify microsites used by tagged bats through radiotelemetry. Specifically, this pilot project aimed to
...
Efforts originally focused on Doctor’s Wall as a capture site to identify local hibernacula microhabitats. This site is the location of multi-year acoustic monitoring with confirmed winter bat activity, which has been interpreted as indicative of hibernacula in the immediate area. However, our field surveys suggested that bats might be flying rapidly through the area, using the site as a flight corridor. Calls recorded on the multi-year detector may, therefore, not be as indicative of immediate, local hibernation as was first believed. Because of these results in 2024/25, the team decided to consider an alternative approach to indeitfying netting sites.

In 2025/26, we planned to deploy additional bat detectors throughout Skaha Bluff Park to gather additional information on bat movement.
