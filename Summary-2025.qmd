...
tbl <-sites|> 
  mutate(
    ...
    site = factor(site, levels = c(
      unique(site[!site %in% c("Gillies Creek Road Detector", 
                                "Gillies Creek Open Forest Detector", 
                                "Smythe Drive Spring Detector")]),
      "Gillies Creek Road Detector",
      "Gillies Creek Open Forest Detector",
      "Smythe Drive Spring Detector"
    ))
  ) |>
  ...
  tab_spanner(label = "Years monitored",
              columns = c(y1819, y1920, y2021, y2122, y2223, y2425)) |>
  cols_align(align = "center",
             columns = c(y1819, y1920, y2021, y2122, y2223, y2425, data_type)) |>
...
4.  Expand collection of existing data. This project aims to identify and include additional acoustic datasets. Possible sources including data from 2025/26 Skaha Park winter monitoring (Kellner pers comm), Sarrell 2012 Skaha winter monitoring, and ECCC/CWS year-round monitoring at Vaseaux (T. Luszcz pers comm)
